  ...
  return (
    <div className="bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 min-h-screen">
        <div className="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-slate-100 prose prose-slate prose-blue">
            ...
            <p className="text-xl text-slate-600 mb-6">Su privacidad y la de sus pacientes es nuestra prioridad.</p>

            <h3 className="text-xl font-bold mb-2">1. Recopilación de Información</h3>
            <p className="mb-4">Recopilamos información necesaria para proporcionar nuestros servicios de análisis de radiografías, incluyendo imágenes médicas anonimizadas y datos de cuenta de usuario profesional.</p>
            ...
            <p className="mb-4">Implementamos medidas de seguridad de nivel industrial, incluyendo encriptación en tránsito y en reposo, para proteger contra el acceso no autorizado.</p>
